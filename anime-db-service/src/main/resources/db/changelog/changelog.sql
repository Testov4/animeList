...
CREATE TABLE "genre" (
    ...
    "name" VARCHAR(200),
    "url" VARCHAR,
    CONSTRAINT "genre_pkey" PRIMARY KEY ("mal_id")
);
...
CREATE TABLE "studio" (
    ...
    "name" VARCHAR(200),
    "url" VARCHAR,
    CONSTRAINT "studio_pkey" PRIMARY KEY ("mal_id")
);
...
CREATE TABLE "anime_genre" (
    "anime_id" INTEGER,
    "genre_id" INTEGER,
    CONSTRAINT "anime_genre_anime_id_fkey" FOREIGN KEY ("anime_id") REFERENCES "anime" ("mal_id") ON UPDATE NO ACTION ON DELETE CASCADE,
    CONSTRAINT "anime_genre_genre_id_fkey" FOREIGN KEY ("genre_id") REFERENCES "genre" ("mal_id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "anime_image" (
    ...
    CONSTRAINT "anime_images_pkey" PRIMARY KEY ("image_id"),
    CONSTRAINT "anime_images_anime_id_fkey" FOREIGN KEY ("anime_id") REFERENCES "anime" ("mal_id") ON UPDATE NO ACTION ON DELETE NO ACTION
...
CREATE TABLE "anime_studio" (
    "anime_id" INTEGER,
    "studio_id" INTEGER,
    CONSTRAINT "anime_studio_anime_id_fkey" FOREIGN KEY ("anime_id") REFERENCES "anime" ("mal_id") ON UPDATE NO ACTION ON DELETE CASCADE,
    CONSTRAINT "anime_studio_studio_id_fkey" FOREIGN KEY ("studio_id") REFERENCES "studio" ("mal_id") ON UPDATE NO ACTION ON DELETE CASCADE
                            );
...
CREATE TABLE "anime_title_synonym" (
    "synonym_id" INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "anime_id" INTEGER,
    "synonym" VARCHAR(255),
    CONSTRAINT "anime_title_synonyms_pkey" PRIMARY KEY ("synonym_id"),
    CONSTRAINT "anime_title_synonyms_anime_id_fkey" FOREIGN KEY ("anime_id") REFERENCES "anime" ("mal_id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
